...
function IconComponent(props) {
	...
	var showStyle = props.showStyle || 'default';

	if (props.disabled) {
		showStyle = 'disabled';
	}

	var className = (0, _classnames2.default)((_classNames = {}, (0, _defineProperty3.default)(_classNames, props.fontFamily, !!props.fontFamily), (0, _defineProperty3.default)(_classNames, props.fontFamily + '-' + props.type, !!props.fontFamily), (0, _defineProperty3.default)(_classNames, 'xricon--' + pshowStyle, !!showStyle), (0, _defineProperty3.default)(_classNames, props.className, !!props.className), _classNames));
